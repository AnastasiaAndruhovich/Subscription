        ...
        <div class="row">
            ...
            <div class="col-8">
                <div class="publication type card">
                    <c:choose>
                        <c:when test="${sessionScope.publicationTypes!=null && !sessionScope.publicationTypes.isEmpty()}">
...
<c:if test="${sessionScope.publicationTypes!=null && !sessionScope.publicationTypes.isEmpty()}">
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <c:choose>
                ...
                <c:otherwise>
                    <li class="page-item">
                        <a class="page-link" href="${pageContext.servletContext.contextPath}/controller?command=show_publication_types&pageNumber=${currentPage-1}" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                            <span class="sr-only">Previous</span>
                        </a>
                    </li>
                ...
                <c:choose>
                    <c:when test="${currentPage eq i}">
                        <li class="page-item active">
                            <a class="page-link" href="${pageContext.servletContext.contextPath}/controller?command=show_publication_types&pageNumber=${i}">${i}</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <li class="page-item">
                        <a class="page-link" href="${pageContext.servletContext.contextPath}/controller?command=show_publication_types&pageNumber=${currentPage+1}" aria-label="Next">
                            <span aria-hidden="true">&raquo;</span>
                            <span class="sr-only">Next</span>
                        </a>
                    </li>
