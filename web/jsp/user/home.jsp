    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                ...
                <button class="btn btn-outline-success my-2 my-sm-0">Searсh</button>
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row" text="center">
                <div class="col-2"></div>
                <div class="col-3">
                    <img src="http://bookashka.name/fb2imgs/e1/e13744dcc4b253fbc4f826e9fb27157d.jpg" alt="" class="w-100">
                </div>
