...
/**
 * Finds page according to relevant command show subscription entity
 */
public class ShowSubscriptionCommand extends BaseCommand {
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        return new CommandResult(TransitionType.FORWARD, ShowEntityList.showSubscriptionList(request, response));
    }
}
