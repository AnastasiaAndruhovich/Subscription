...
public enum CommandType {
    ...
    //user
    SHOW_USERS, LOGIN, LOGOUT, SIGN_UP, BLOCK_USER, UNBLOCK_USER, UPDATE_USER, FIND_USER_BY_LOGIN, FIND_USER_BY_ACCOUNT_NUMBER,
    FIND_USER_BY_SUBSCRIPTION, FIND_USER_BY_PAYMENT_NUMBER, FIND_BLOCKED_USERS_BY_ADMIN, FIND_USER, CHANGE_PASSWORD,
